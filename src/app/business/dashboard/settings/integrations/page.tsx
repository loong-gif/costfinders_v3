    ...
    <div className="space-y-6">
      ...
      <div>
        <Link
          ...
          className="inline-flex items-center gap-1 text-sm text-[#78350f] hover:text-[#451a03] transition-colors mb-4"
        >
            ...
            <Card key={integration.id} className="p-5">
              <div className="flex flex-col h-full">
                <div className="flex items-start gap-4 mb-4">
                  <div className="flex-shrink-0 w-12 h-12 rounded-xl bg-[#faf5ee] border border-[#d4c4b0] flex items-center justify-center">
                    <Icon size={24} weight="light" className="text-[#78350f]" />
                  </div>
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="px-2 py-0.5 text-xs font-medium bg-amber-800/8 text-amber-800 rounded-full">
                        Coming Soon
                      </span>
                    </div>
