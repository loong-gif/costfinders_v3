...
export function BusinessBillingOverride({
  ...
  return (
    <div className="space-y-6">
      ...
      <Card variant="glass" padding="lg">
        ...
        <div className="mb-6 p-4 rounded-xl bg-[#f2ebe2] border border-[#d4c4b0]">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div>
              <p className="text-xs text-[#92400e] mb-1">Claimed</p>
              <p className="text-sm text-[#451a03]">
                {business.claimedAt ? 'Yes' : 'No'}
              </p>
            </div>
            <div>
              <p className="text-xs text-[#92400e] mb-1">Verified</p>
              <p className="text-sm text-[#451a03]">
        ...
        <div className="mb-6">
          <label className="flex items-center gap-3 cursor-pointer">
            <input
              ...
              className="w-5 h-5 rounded border-[#d4c4b0] bg-[#f2ebe2] text-amber-800 focus:ring-amber-800/40 cursor-pointer"
            />
            <span className="text-sm font-medium text-[#451a03]">
              Enable override mode
            </span>
          </label>
          <p className="text-xs text-[#92400e] mt-1 ml-8">
        ...
        {overrideEnabled && (
          <div className="space-y-6 animate-in fade-in duration-200">
            {/* Tier Assignment */}
            <div>
              <label className="block text-sm font-medium text-[#78350f] mb-2">
                Tier Assignment
              </label>
                    ...
                    className={`
                      ...
                      ${
                        selectedTier === option.value
                          ? 'border-amber-800 bg-amber-800/8 text-amber-800'
                          : 'border-[#d4c4b0] bg-[#f2ebe2] text-[#78350f] hover:border-[#c4b09a]'
                      }
                    `}
                  >
                    {option.label}
            ...
            <div>
              ...
              <div className="flex items-center gap-3">
                <div className="flex items-center gap-2">
                  <Plus size={16} className="text-[#78350f]" />
                  <input
                    type="number"
                    value={creditsToGrant}
                    onChange={(e) => setCreditsToGrant(Number(e.target.value))}
                    className="w-24 px-3 py-2 bg-[#f2ebe2] border border-[#d4c4b0] rounded-xl text-[#451a03] focus:border-amber-800 focus:outline-none"
                    min={0}
                    placeholder="0"
                  />
                  <span className="text-sm text-[#78350f]">credits</span>
                </div>
              ...
              <div className="flex items-center gap-3">
                <div className="flex items-center gap-2">
                  ...
                  <input
                    ...
                    placeholder="—"
                  />
                  <span className="text-sm text-[#78350f]">/lead</span>
                </div>
                <p className="text-xs text-[#92400e]">
      ...
      {/* Confirmation Modal */}
      {showConfirmation && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-[#451a03]/40 backdrop-blur-sm">
          <Card variant="glass" padding="lg" className="max-w-md w-full">
            ...
            <div className="space-y-2 mb-6 p-3 rounded-lg bg-[#f2ebe2]">
              ...
              <div className="flex justify-between text-sm">
                ...
                <span className="text-[#451a03]">{billingStatus}</span>
              </div>
              {creditsToGrant > 0 && (
                <div className="flex justify-between text-sm">
                  <span className="text-[#78350f]">Credits Granted</span>
                  <span className="text-emerald-600">+{creditsToGrant}</span>
                </div>
              )}
              {customLeadPrice && (
                <div className="flex justify-between text-sm">
      ...
      <Card variant="glass" padding="lg">
        ...
        {overrides.length === 0 ? (
          <div className="text-center py-8">
            <div className="w-12 h-12 mx-auto rounded-full bg-[#f2ebe2] flex items-center justify-center mb-3">
              <Clock size={24} className="text-[#92400e]" />
            </div>
            <p className="text-[#78350f]">No override history</p>
          ...
          <div className="space-y-3">
            {overrides.map((override) => (
              <div
                key={override.id}
                className="p-4 rounded-xl bg-[#f2ebe2] border border-[#d4c4b0]"
              >
                <div className="flex items-start justify-between mb-2">
                  <div className="flex items-center gap-2">
                    <div className="w-6 h-6 rounded-full bg-amber-800/8 flex items-center justify-center">
                ...
                <div className="space-y-1 ml-8">
                  ...
                  {override.newBillingStatus && (
                    <div className="flex items-center gap-2 text-sm">
                      <span className="text-[#78350f]">Status:</span>
                  ...
                  <p className="text-sm text-[#92400e] mt-2 italic">
                    &quot;{override.reason}&quot;
                  </p>
                </div>
              </div>
